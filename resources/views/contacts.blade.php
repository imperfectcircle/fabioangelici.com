...
>
    <section id="hero" class="">
        ...
        <div class="lg:col-span-2 lg:col-start-2 text-center p-5">
            ...
            <div id="contatti" class="lg:w-6/12 mx-auto p-5">
