<form class="" action="{{ route('public.form') }}" method="POST">
    ...
    <div class="flex pb-5">
        ...
        <label for="privacy"><p class="text-sm pl-5">Dichiaro di aver preso visione dell'informativa sulla <a class="text-red-500 hover:text-red-700" href="https://www.iubenda.com/privacy-policy/71101442" target="_blank">privacy</a>, pertanto presto il mio consenso al trattamento dei dati per ricevere le informazioni richieste</p></label>
