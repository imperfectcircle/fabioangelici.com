<x-layout :title="'Servizi per Agenzie | Fabio Angelici Web Developer'"
    :description="'Sei alla ricerca di un web developer freelance con cui instaurare un rapporto di partnership commerciale? Scopri chi sono.'"
    :ogUrl="'https://www.fabioangelici.com/servizi-per-agenzie'"
    ogImage=''
    :ogDescription="'Sei alla ricerca di un web developer freelance con cui instaurare un rapporto di partnership commerciale? Scopri chi sono.'"
    :ogTitle="'ervizi per Agenzie | Fabio Angelici Web Developer'"
    :canonical="'https://fabioangelici.com/servizi-per-agenzie'"
>
    <section id="hero">
        ...
        <div class="p-10 bg-gray-300">
            <div class="md:w-4/6 md:mx-auto">
                <h2 class="py-10 text-3xl font-bold mb-3 md:text-5xl text-sky-600">Cosa so fare</h2>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 place-items-center gap-20 md:w-4/6 md:mx-auto">
                <div class="space-y-5">
                    <p class="text-xl">
                        Sono specializzato sia nello sviluppo frontend che quello backend. Utilizzo le tecnologie più moderne come Laravel e Node.js con Express e React per lo sviluppo dei siti.  
                    </p>
                    <p class="text-xl">Lavoro esclusivamente scrivendo codice a mano senza l'utilizzo di template realizzati da altri. Ogni cosa che creo è unica e ritagliata sulle esigenze del cliente.</p>
                    <p class="text-xl">Creo pannelli di gestione personalizzati avvalendomi del pacchetto Nova per Laravel o creandoli manualmente per mantenere coerenza con l'applicazione e le necessità del cliente.</p>
                    <p class="text-xl">Realizzo SPA con React ed utilizzo Inertia.js per integrarle con il backend, in modo da non dover sviluppare REST API per farli comunicare, velocizzando lo sviluppo ed andando ad eliminare eventuali problematiche come errori CORS</p>
                </div>
                <div class="space-y-5">
                    <p class="text-xl">
                        Ogni mio progetto è versionato tramite git. Generalmente utilizzo GitHub o GitLab.  
                    </p>
                    <p class="text-xl">Ho un mio server di test dove carico i siti in lavorazione per mettere al corrente il cliente dell’avanzamento dei lavori.</p>
                    <p class="text-xl">La creazione del layout in base alla bozza grafica fornita è maniacale. La responsività viene curata nei minimi particolari.</p>
                    <p class="text-xl">Ho inoltre un'ottima conoscenza della command line per tutte le operazioni più comuni.</p>
                </div>
            </div>
        </div>
    </section>    
