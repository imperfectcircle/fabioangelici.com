      ...
      <PublicLayout>
        <section className="relative grid grid-cols-1 lg:grid-cols-4 min-h-screen overflow-hidden gap-5">
          ...
          <motion.div
            ...
            className="home hidden md:block mx-auto mt-5 lg:mt-0 bg-cover bg-center md:w-48 md:h-48 lg:w-72 lg:h-72 xl:w-96 xl:h-96 border-2 border-dark shadow-lg shadow-light lg:absolute lg:top-1/2 lg:left-3/4 lg:-translate-y-1/2 lg:-translate-x-1/2"
          ></motion.div>
        </section>
