<x-layout :title="'Fabio Angelici | Portali ecommerce'"
    ...
    :canonical="'https://fabioangelici.com/ecommerce'"
>
    <section id="hero" class="flex flex-col items-center md:grid md:grid-cols-6 md:items-start mb-10">
        ...
        <div class="md:h-full md:flex md:flex-col md:justify-center space-y-5p-5 mt-10 md:col-span-2 md:col-start-2 text-xl md:p-0 md:pr-5 md:space-y-5 ">
